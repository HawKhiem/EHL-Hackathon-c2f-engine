...
**This is the `track/cognition` branch.** Read [TRACK.md](TRACK.md) for the design language, this branch's ports, and the kick-off checklist. The real brief goes in [CHALLENGE.md](CHALLENGE.md) and outranks any guess in TRACK.md.
